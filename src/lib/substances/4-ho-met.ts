...
export const _4_ho_met: Substance = 
{
  ...
  "class": "Substituted tryptamines",
  "description": "4-Hydroxy-N-methyl-N-ethyltryptamine (also known as colour, methylcybin, metocin, and 4-HO-MET) is a lesser-known novel psychoactive class psychedelic substance of the chemical class tryptamine class. 4-HO-MET is structurally related to psilocin, the active ingredient in psilocybin mushrooms (\"magic mushrooms\"). It is thought to produce its effects by binding to serotonin receptors in the brain. 4-HO-MET was first synthesized by the American chemist Alexander Shulgin, who documented it in his 1997 book TiHKAL (\"Tryptamines I Have Known and Loved\"). It is assumed to have a similar risk and toxicity profile as psilocin and 4-AcO-DMT but there is no data to support this.",
  "effects": {
    "positive": [
