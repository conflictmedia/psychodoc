...
export const phenibut: Substance = 
{
  ...
  "harmReduction": [
    ...
    "Stimulants -  Phenibut is reported to enhance the positive effects of stimulants as well as reduce jitteriness and anxiety. However, this combination can be dangerous due to the risk of excessive intoxication. Stimulants mask the sedative effects of phenibut; once the stimulant wears off, the depressant effects of phenibut will be significantly increased, leading to intensified disinhibition as well as . If combined, one should strictly limit themselves to a certain dose of phenibut prior to stimulant consumption and not redose. This combination can also potentially result in significant dehydration."
  ],
