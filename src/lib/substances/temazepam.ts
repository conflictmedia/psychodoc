...
export const temazepam: Substance = 
{
  ...
  "routeData": {
    "oral": {
      ...
      "notes": "Afterglow: 3.5-18.4 hours"
    }
  },
  "interactions": [],
  "harmReduction": [
    ...
    "Stimulants -  It is dangerous to combine benzodiazepines with stimulants due to the risk of excessive intoxication. Stimulants decrease the sedative effect of benzodiazepines, which is the main factor most people consider when determining their level of intoxication. Once the stimulant wears off, the effects of benzodiazepines will be significantly increased, leading to intensified disinhibition as well as . If combined, one should strictly limit themselves to only dosing a certain amount of benzodiazepines per hour. This combination can also potentially result in severe dehydration if hydration is not monitored."
  ],
