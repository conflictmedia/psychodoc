...
export const acetylfentanyl: Substance = 
{
  ...
  "class": "Anilidopiperidine",
  "description": "Acetylfentanyl is a synthetic psychoactive class opioid substance of the chemical class anilidopiperidine chemical class that produces analgesic, anxiety suppressing, and euphoric effects when administered. It is a structural analog of fentanyl. Studies have estimated acetylfentanyl to be between five to fifteen times more potent than heroin, eighty times more potent than morphine, and fifteen times less potent than its parent compound, fentanyl. This compound has never been licensed for medical use and has only been sold as a designer drug. Acetylfentanyl was discovered at the same time as fentanyl and was rarely encountered on the illicit market in the late 1980s as it was never commonly used.",
  "effects": {
    "positive": [
  ...
  "harmReduction": [
    ...
    "unintentionally spilling a very small amount of acetylfentanyl on one's skin could result in a fatal overdose."
  ],
